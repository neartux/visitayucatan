									...
									<table cellpadding="0" cellspacing="0">
										<? for($t=0; $tabla["idcombinacion"][$t]; $t++){
											...
											<tr>
												...
												<td>
													<button type="button" class="btnReservaPaquete precio_sencilla" onclick="reservaPaqueteOn('1', '<? echo $tabla["idcombinacion"][$t]; ?>', '<? echo $idpaquete; ?>', '<? echo $tabla["sencilla"][$t]; ?>')" id="<? echo $tabla["idcombinacion"][$t]; ?>">
